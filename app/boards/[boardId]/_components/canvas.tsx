...
export const Canvas = ({
  ...
  const onPointerDown = useCallback(
    (e: React.PointerEvent) => {
      ...
      if(canvasState.mode === CanvasMode.Pencil || canvasState.mode === CanvasMode.Pen){
  ...
  const onPointerUp = useMutation((
    ...
    }else if (canvasState.mode === CanvasMode.Pencil || canvasState.mode === CanvasMode.Pen){
      insertPath();
  ...
  }, [camera, canvasState, history, insertLayer, insertPath, unselectLayer, setCanvasState])
